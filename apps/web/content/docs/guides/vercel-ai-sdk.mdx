...
| `run_web_agent` | Opt-in goal-based browser automation; may consume paid provider credits. |

Each tool uses Zod `inputSchema` (AI SDK 5/6). Search/map/crawl/extract/agent are omitted when the client cannot do them.
