...
```bash
curl https://scrape-sdk-olive.vercel.app/docs/quickstart.md
```
...
```bash
curl https://scrape-sdk-olive.vercel.app/llms.txt
curl https://scrape-sdk-olive.vercel.app/feeds/docs.jsonl
```
