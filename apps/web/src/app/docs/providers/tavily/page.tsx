  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <h1 className="font-editorial text-4xl tracking-tight text-white capitalize">tavily Adapter</h1>
        <p className="text-sm text-[#a09f97]">Standardized TypeScript adapter for tavily extraction.</p>
      </div>
